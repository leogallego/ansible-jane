...
| Project | Language | What We Used | License | Link |
|---------|----------|--------------|---------|------|
| **Kai 9000** | Kotlin (KMP) | MCP client via OkHttp (~130 LOC), universal Tool interface, multi-provider LLM chain, KMP architecture | Apache 2.0 | [GitHub](https://github.com/SimonSchubert/Kai) |
| **PennywiseAI** | Kotlin | Validated dynamic system prompt injection for domain context; on-device inference via LiteRT-LM with streaming Flow | AGPL 3.0 | [GitHub](https://github.com/sarim2000/pennywiseai-tracker) |

## Framework Evaluations

| Project | Language | Status | License | Link |
|---------|----------|--------|---------|------|
| **Koog** (JetBrains) | Kotlin | **Adopted** (PR #297). Used for LLM streaming via `OpenAILLMClient` and `GeminiLlmProvider`. Version 1.0.0. | Apache 2.0 | [GitHub](https://github.com/JetBrains/koog) |
| **ADK for Kotlin** (Google) | Kotlin | v0.1.0 (experimental, 2025-05). Multi-agent systems with MCP tool support, on-device Gemini Nano via ML Kit. Very early but relevant to our agent architecture | Apache 2.0 | [GitHub](https://github.com/google/adk-kotlin) |
...
| Project | Stars (Jun 2026) | Contents | License | Link |
|---------|-----------------|----------|---------|------|
...
| Project | Language | Stars (Jun 2026) | What to Look At | License | Link |
|---------|----------|-----------------|-----------------|---------|------|
| **PocketPal AI** | TypeScript (React Native) | 7,272 | Model management UX, on-device inference patterns, model download/caching | MIT | [GitHub](https://github.com/a-ghorbani/pocketpal-ai) |
| **ChatterUI** | TypeScript (React Native) | 2,496 | Mobile chat frontend UX, multi-backend support | AGPL 3.0 | [GitHub](https://github.com/Vali-98/ChatterUI) |
| **Off-Grid Mobile AI** | TypeScript | 2,473 | Fully offline mobile AI: text, vision, image gen without internet | MIT | [GitHub](https://github.com/alichherawalla/off-grid-mobile-ai) |

### On-Device Inference

| Project | Language | Stars (Jun 2026) | What to Look At | License | Link |
|---------|----------|-----------------|-----------------|---------|------|
| **ExecuTorch** | Python/C++ | 4,732 | PyTorch on-device deployment for mobile/embedded — relevant if we run models directly on Android | Other | [GitHub](https://github.com/pytorch/executorch) |

### Agent Frameworks

| Project | Language | Stars (Jun 2026) | What to Look At | License | Link |
|---------|----------|-----------------|-----------------|---------|------|
| **MobileRun** (fka DroidRun) | Python | 8,568 | LLM-agnostic mobile agent — natural language device automation | MIT | [GitHub](https://github.com/droidrun/mobilerun) |

### Local Inference Servers

| Project | Language | Stars (Jun 2026) | What to Look At | License | Link |
|---------|----------|-----------------|-----------------|---------|------|
| **RamaLama** | Python | 2,895 | Local AI model runner from Red Hat/Fedora ecosystem, container-based | Apache 2.0 | [GitHub](https://github.com/containers/ramalama) |
...
| Compose Material 3 | 1.12.0-alpha01 | [GitHub](https://github.com/JetBrains/compose-multiplatform-core) |
| CMP Navigation | 2.9.2 | [GitHub](https://github.com/JetBrains/compose-multiplatform-core) |
| CMP Lifecycle | 2.11.0-beta01 | [GitHub](https://github.com/JetBrains/compose-multiplatform-core) |
| Android Gradle Plugin | 9.2.1 | [Google Maven](https://maven.google.com/web/index.html#com.android.tools.build:gradle) |
...
- `docs/reports/mcp-proxy-research-2026-05-22.md` — MCP proxy/router solutions relevant to ToolRouter optimization
